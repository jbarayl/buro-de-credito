...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compra.adeudo'
        db.add_column('compras_app_compra', 'adeudo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=18, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compra.adeudo'
        db.delete_column('compras_app_compra', 'adeudo')
