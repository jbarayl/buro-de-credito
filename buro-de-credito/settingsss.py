# Django settings for buro-de-credito project.
#encoding:utf-8
...
MEDIA_URL = 'http://bccomercial.webfactional.com/media/'
...
STATICFILES_DIRS = (
    ...
    '/home/bccomercial/webapps/django/buro-de-credito/creditos/static/',
)
...
SECRET_KEY = '9zmx-g=1io-iqr9cz*!5(x@ek3_0c(=l*0l9$xdm(i1qq356n2'
...
ROOT_URLCONF = 'buro-de-credito.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'buro-de-credito.wsgi.application'
