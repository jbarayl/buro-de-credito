...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('creditos_credito', 'fecha_liquidacion',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=2009, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'creditos.credito': {
            ...
            'fecha_liquidacion': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
