...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Credito.fecha_liquidacion'
        db.alter_column('creditos_credito', 'fecha_liquidacion', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Credito.fecha_liquidacion'
        db.alter_column('creditos_credito', 'fecha_liquidacion', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
    ...
    models = {
        ...
        'creditos.credito': {
            ...
            'fecha_liquidacion': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
