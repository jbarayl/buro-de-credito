...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('creditos_userprofile')


        # Renaming column for 'Credito.empresa_otorga' to match new field type.
        db.rename_column('creditos_credito', 'empresa_otorga_id', 'empresa_otorga')
        # Changing field 'Credito.empresa_otorga'
        db.alter_column('creditos_credito', 'empresa_otorga', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'Credito', fields ['empresa_otorga']
        db.delete_index('creditos_credito', ['empresa_otorga_id'])


    def backwards(self, orm):
        # Adding index on 'Credito', fields ['empresa_otorga']
        db.create_index('creditos_credito', ['empresa_otorga_id'])

        # Adding model 'UserProfile'
        db.create_table('creditos_userprofile', (
            ('empresa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creditos.Empresa'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('creditos', ['UserProfile'])


        # Renaming column for 'Credito.empresa_otorga' to match new field type.
        db.rename_column('creditos_credito', 'empresa_otorga', 'empresa_otorga_id')
        # Changing field 'Credito.empresa_otorga'
        db.alter_column('creditos_credito', 'empresa_otorga_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['creditos.Empresa']))
